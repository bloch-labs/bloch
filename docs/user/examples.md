...
- `examples/multifile/*` — Demonstrates imports across modules.
...
Use `--echo=all` for verbose output during multi-shot runs. Feel free to modify the examples to explore gates and annotations; just revert changes before committing to keep tests green.

...
- CLI options (emit-qasm, shots, echo) forwarded by `main.cpp`
...
- Control-flow truthiness currently only checks int/bit values; other types act as false (open issue).
